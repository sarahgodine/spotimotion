...
trackList = []
playlistList = [
	('argentina', 'spotify:user:spotifycharts:playlist:37i9dQZEVXbMMy2roB9myp'), #arg
	...
	('costa rica', 'spotify:user:spotifycharts:playlist:37i9dQZEVXbMZAjGMynsQX'),
	('czech republic', 'spotify:user:spotifycharts:playlist:37i9dQZEVXbIP3c3fqVrJY'),
	('denmark', 'spotify:user:spotifycharts:playlist:37i9dQZEVXbL3J0k32lWnN'),
	('dominican republic', 'spotify:user:spotifycharts:playlist:37i9dQZEVXbKAbrMR8uuf7'),
	('ecuador', 'spotify:user:spotifycharts:playlist:37i9dQZEVXbJlM6nvL1nD1'),
	('el salvador', 'spotify:user:spotifycharts:playlist:37i9dQZEVXbLxoIml4MYkT'),
	...
	('hong kong', 'spotify:user:spotifycharts:playlist:37i9dQZEVXbLwpL8TjsxOG'),
	...
	('new zealand', 'spotify:user:spotifycharts:playlist:37i9dQZEVXbM8SIrkERIYl'),
	...
	('united kingdom', 'spotify:user:spotifycharts:playlist:37i9dQZEVXbLnolsZ8PSNw'),
	('united states', 'spotify:user:spotifycharts:playlist:37i9dQZEVXbLRQDuF5jeBp'),
